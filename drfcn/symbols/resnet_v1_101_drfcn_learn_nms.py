...
class resnet_v1_101_drfcn_learn_nms(Symbol):
    ...
    def get_train_symbol(self, cfg):
        ...
        # RPN layers
        rpn_cls_score, rpn_bbox_pred = self.get_rpn(conv_feats[0], num_anchors)
        ...
        # res5
        drfcn_feat = conv_feats[1]
        conv_new_1 = mx.sym.Convolution(data=drfcn_feat, kernel=(1, 1), num_filter=256, name="conv_new_1")
    ...
    def get_test_symbol(self, cfg):
        ...
        # RPN
        rpn_cls_prob, rpn_bbox_pred = self.get_rpn(conv_feats[0], num_anchors)
