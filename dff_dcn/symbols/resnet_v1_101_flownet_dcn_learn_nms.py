...
class resnet_v1_101_flownet_dcn_learn_nms(Symbol):
    ...
    def get_train_symbol(self, cfg):
        ...
        conv_feat = self.get_resnet_v1_conv4(data_ref)
        ...
        # res5
        dcn_feat = relu1
        conv_new_1 = mx.sym.Convolution(data=dcn_feat, kernel=(1, 1), num_filter=256, name="conv_new_1")
    ...
    def learn_nms(self, cfg, cls_score, bbox_pred, rois, im_info):
        ...
        num_fg_classes = num_classes - 1
        bbox_means = cfg.TEST.BBOX_MEANS
        bbox_stds = cfg.TEST.BBOX_STDS 
        ...
        return sorted_bbox, sorted_score, nms_final_score
    ...
    def get_key_test_symbol(self, cfg):
        ...
        # RPN
        rpn_cls_prob, rpn_bbox_pred = self.get_rpn(conv_feat)
    ...
    def get_cur_test_symbol(self, cfg):
        ...
        sorted_bbox, sorted_score, nms_final_score = self.learning_nms(cfg, cls_score, bbox_pred, rois, im_info)
        output_sym_list = output_sym_list.extend([sorted_bbox, sorted_score, nms_final_score])
    ...
    def init_weight_resnet(self, cfg, arg_params, aux_params):
